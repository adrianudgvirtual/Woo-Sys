...
$url_API="https://developers.syscom.mx/api/v1/marcas/hilookbyhikvision/productos";
...
for ($i=1; $i<=$paginas; $i++){
    $url_API="https://developers.syscom.mx/api/v1/marcas/hilookbyhikvision/productos?pagina=$i";
