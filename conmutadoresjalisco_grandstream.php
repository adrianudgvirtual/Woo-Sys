...
// ================================
$url_API_woo = 'https://conmutadoresjalisco.com.mx';
$ck_API_woo = 'ck_4f22b657748ebe34d8e75d5733ccfd1ba72cf020';
$cs_API_woo = 'cs_a46b6c416a2a03433c10e17481e65b91f3ef1ff9';
...
$url_API="https://developers.syscom.mx/api/v1/marcas/grandstream/productos";
...
for ($i=1; $i<=$paginas; $i++){
    $url_API="https://developers.syscom.mx/api/v1/marcas/grandstream/productos?pagina=$i";
    ...
    if (! $result) {
        ...
        echo("✔ Productos actualizados correctamente: $products. Pagina: $i <br/>");
    }
}
