...
$url_API="https://developers.syscom.mx/api/v1/marcas/zktecogreenlabel/productos";
...
for ($i=1; $i<=$paginas; $i++){
    $url_API="https://developers.syscom.mx/api/v1/marcas/zktecogreenlabel/productos?pagina=$i";
