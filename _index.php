...
$ck_API_woo = 'ck_7fadc8001fe856862b9be23c0c1e29bdd61d3d9e';
$cs_API_woo = 'cs_24657d77b82b4aaf4d392672d2e12e37b1313d93';
...
$url_API="https://developers.syscom.mx/api/v1/marcas/hikvision/productos";
...
for ($i=1; $i<=$paginas; $i++){
    $url_API="https://developers.syscom.mx/api/v1/marcas/hikvision/productos?pagina=$i";
    ...
    if (! $result) {
        ...
        print("✔ Productos actualizados correctamente pagina: $i \n");
    }
}
